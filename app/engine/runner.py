...
def run_engine(question: str, chat_history=None, mode: str = "rag") -> dict:
    if mode == "rag":
        ...
        answer = chain.invoke({"question": question, "chat_history": chat_history or []})
        return {"answer": answer, "intent": "rag", "tools_used": ["search_documents", "generate_answer"]}

    elif mode == "react":
        result = run_react_agent(question=question, chat_history=chat_history or [])
        return {
